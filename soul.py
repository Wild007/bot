...
TOKEN = '7382759347:AAEd-6iZ_vzLSmaPG9hGl8o_ktGCBYSfcFk'
MONGO_URI = 'mongodb+srv://xtreme:xtreme@cluster0.9lvfaop.mongodb.net/?retryWrites=true&w=majority&appName=piro&tlsAllowInvalidCertificates=true'
FORWARD_CHANNEL_ID = -1002157893570
CHANNEL_ID = -1002157893570
error_channel_id = -1002157893570
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/team_xtreme/14974*", parse_mode='Markdown')
